...
mongoose.connect(process.env.MLAB_URI || 'mongodb://akshatamw:akshata2607@ds153730.mlab.com:53730/amsdb', {useMongoClient: true} )
...
app.post('/api/exercise/new-user', (req,res,next) => {
  ...
  if(username){
    ...
    User.findOne({username: newUser.username}, (error,data) => {
      ...
      res.send("you need to provide username");
    }
});
